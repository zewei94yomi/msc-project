...
class Order:
    ...
    def __init__(self, uuid, start_location: Coordinate, end_location: Coordinate, time: datetime, description=""):
        ...
        self.status = OrderStatus.WAITING   # Current status: 1.WAITING 2.ACCEPTED 3.DELIVERING 4.DELIVERED
